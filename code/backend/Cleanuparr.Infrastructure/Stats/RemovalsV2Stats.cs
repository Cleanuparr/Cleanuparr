...
/// <summary>
/// Downloads removed from the queue in the window (QueueItemDeleted events), broken down by reason.
...
{
    /// <summary>
    /// Total downloads removed in the window (all reasons). Equal to the sum of <see cref="ByReason"/>.
    /// </summary>
