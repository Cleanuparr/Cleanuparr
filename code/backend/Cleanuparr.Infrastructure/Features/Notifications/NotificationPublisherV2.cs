...
public class NotificationPublisherV2 : INotificationPublisher
{
    private readonly ILogger<NotificationPublisherV2> _logger;
    ...
    public NotificationPublisherV2(
        ILogger<NotificationPublisherV2> logger,
