...
namespace Cleanuparr.Infrastructure.Tests.Features.DownloadClient.QBittorrent;

public class QBitServiceQCTests
{
    [Fact]
    public async Task ShouldRemoveFromArrQueueAsync_WhenTorrentNotFound_ReturnsNotFoundResult()
    {
        // Arrange
        var mockService = new Mock<QBitService>();
        var hash = "test-hash";
    ...
    [Fact]
    public void QBitTorrentInfo_CreatesCorrectWrapper()
    {
        // Arrange
        ...
        wrapper.CompletionPercentage.ShouldBe(50.0, 0.1);
