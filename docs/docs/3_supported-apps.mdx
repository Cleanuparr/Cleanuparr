...
<AppCard
  ...
  apps={[
    ...
    {
      name: 'Sportarr',
      iconLight: useBaseUrl('/img/icons/sportarr-light.svg'),
      iconDark: useBaseUrl('/img/icons/sportarr-dark.svg'),
      url: 'https://sportarr.net',
      color: '#dc2626'
    },
    {
      name: 'LazyLibrarian',
      iconLight: useBaseUrl('/img/icons/lazylibrarian-light.svg'),
      iconDark: useBaseUrl('/img/icons/lazylibrarian-dark.svg'),
