...
**Note for rTorrent**: rTorrent does not have built-in authentication. Username and password are used for HTTP Basic Auth handled by a reverse proxy (e.g., nginx, Apache) in front of rTorrent's XML-RPC interface.
