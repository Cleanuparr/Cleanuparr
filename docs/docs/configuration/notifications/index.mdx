...
**Triggered When**: Download Cleaner stops a completed download.

The torrent stays in the download client and its files stay on disk.
...
<ConfigSection
  title="Force Imported"
  icon="check"
>

**Triggered When**: The Queue Cleaner got the *arr to import a download it had blocked, instead of striking it. Cleanuparr sends this once, after the download leaves the *arr queue.
See [Force Import](../queue-cleaner#failed-import-force-import).
