...
After saving your OIDC settings, click the **Link Account** button to connect your Cleanuparr account to your identity provider. This opens your provider's login page in a new window, where you authenticate and authorize Cleanuparr.

Once linking is complete, your provider's **subject identifier** (a unique ID for your account) is displayed. Only this specific identity can sign in via OIDC — no other accounts from your provider will be able to log in.
...
Exclusive Mode can only be enabled after you have successfully linked an OIDC account.
