...
<h2 id="health-check-endpoints" className={styles.sectionTitle}>
...
<h2 id="health-check-components" className={styles.sectionTitle}>
  <span className={styles.sectionIcon}>🔍</span>
...
<h2 id="environment-variables" className={styles.sectionTitle}>
  <span className={styles.sectionIcon}>🐳</span>
...
<h2 id="troubleshooting" className={styles.sectionTitle}>
  <span className={styles.sectionIcon}>🔧</span>
  Troubleshooting
</h2>
