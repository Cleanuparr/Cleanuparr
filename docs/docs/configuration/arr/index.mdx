...
Configure connections to your *arr applications (Sonarr, Radarr, Lidarr, Readarr, Whisparr, Sportarr). Each application type has its own configuration page where you can manage multiple instances.
