...
<h2 id="system-settings" className={styles.sectionTitle}>
...
<h2 id="http-configuration" className={styles.sectionTitle}>
...
<h2 id="search-settings" className={styles.sectionTitle}>
  <span className={styles.sectionIcon}>🔍</span>
  Search Settings
</h2>
...
<h2 id="download-management" className={styles.sectionTitle}>
  <span className={styles.sectionIcon}>📦</span>
  Download Management
</h2>
...
<h2 id="logging-settings" className={styles.sectionTitle}>
  <span className={styles.sectionIcon}>📝</span>
  Logging Settings
</h2>
