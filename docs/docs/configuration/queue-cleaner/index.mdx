...
<h2 id="failed-import-settings" className={styles.sectionTitle}>
...
<h2 id="stalled-download-settings" className={styles.sectionTitle}>
...
<h2 id="slow-download-settings" className={styles.sectionTitle}>
  <span className={styles.sectionIcon}>🐌</span>
  Slow Download Rules
</h2>
