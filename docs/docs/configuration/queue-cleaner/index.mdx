...
You get the notification after the download leaves the *arr queue.
Cleanuparr stays quiet about the removals it asked for itself.
A download you delete in the *arr, or one the *arr drops itself, still reports as imported.
