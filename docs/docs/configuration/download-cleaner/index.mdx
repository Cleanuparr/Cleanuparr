...
<h2 id="seeding-settings" className={styles.sectionTitle}>
...
<h2 id="seeding-rules" className={styles.sectionTitle}>
  <span className={styles.sectionIcon}>📏</span>
  Seeding Rules
</h2>
...
<h2 id="unlinked-download-settings" className={styles.sectionTitle}>
  <span className={styles.sectionIcon}>🔗</span>
